...
<ul class="header-right-menu__item dropdown">
          ...
          <div class="menu-template">
            ...
            <li class="menu__item">Буду читать</li> 
              ...
              <li class="menu__item text-danger">Удалить</li>
                  ...
                  <div class="dropdown">
              <button class="manga-search__sort-button">
                <span>Читаю</span>
              </button>
              <span>0</span>
              <button class="manga-search__sort-button">
      ...
      <div class="media-card__caption">
          ...
          <div>
            ...
            <div style="margin-left: -17px;">
              <span class="updates__date">
                <svg class="svga" style="fill: currentColor; width: .8rem; margin-right: 4px;" focusable="false" viewBox="0 0 24 24" aria-hidden="true">
