...
@section('content')
  ...
  <div class="container container_offset team-profile">
    <div class="aside aside_left">
          ...
          <div class="team-profile__cover cover cover_responsive" style="background-image: url(/)"></div>
        </div>
  ...
  <div class="team-profile-stats__item">
    ...
    <div class="team-profile-stats__name">Главы</div>
              ...
              <div class="paper" id="manga-list">
      <div class="section__header manga-block-items__header">
      <div class="manga-block-items__title text-truncate">Комиксы</div>
    </div>
