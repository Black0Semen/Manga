                ...
                <div class="top-user">
                  <div class="top-user__body">
                    <div class="top-user__username">
                      <div class="top-user__rank">Заявка №1</div>
                    </div>
                    <div class="top-user__lvl">Отправитель: Aspert</div>
                    <div>
                      <div class="top-user__lvl">Дата создания: 2023-02-28 11:05:44</div>
                    </div>
                    <div>
                      <div class="top-user__lvl">Название: Настоящий Мужчина</div>
                    </div>
                    <div>
                      <div class="top-user__lvl">Описание: Хан Ю Хён становится самым молодым генеральным директором Hansung, успешной электронной компании, построенной на хождении по головам коллег. Но никого, о ком он заботился, нет рядом, чтобы отпраздновать повышение вместе с ним.</div>
                    </div>
                    <div>
                      <div class="top-user__lvl">Ссылка на оригинал: A Real Man</div>
                    </div>
                    <div>
                      <div class="top-user__lvl">Срок: 10 дней</div>
                    </div>
                    <div>
